...
async function updateBlog(req, res){
  try {
    ...
    let query = `UPDATE myblogs SET title='${title}', description='${description}', "startDate"='${startDate}', "endDate"='${endDate}', duration=${monthDuration}, html='${html}', css='${css}', javascript='${javascript}', php='${php}', image='${image}', "createdAt"=NOW(), "updatedAt"=NOW() WHERE id=${id}`
